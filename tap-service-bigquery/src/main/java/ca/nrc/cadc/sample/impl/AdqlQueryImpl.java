...
import ca.nrc.cadc.tap.expression.BqExpressionDeParser;
import ca.nrc.cadc.tap.parser.BqQuerySelectDeParser;
import ca.nrc.cadc.tap.parser.QuerySelectDeParser;
import ca.nrc.cadc.tap.parser.converter.BqRegionConverter;
...
public class AdqlQueryImpl extends AdqlQuery {
    private static final Logger log = Logger.getLogger(AdqlQueryImpl.class);
    ...
    protected void init() {
        ...
        tnc.put("tapdata.allwise", "`bigquery-public-data.wise_all_sky_data_release.all_wise`");
        tnc.put("tapdata.mepwise", "`bigquery-public-data.wise_all_sky_data_release.mep_wise`");
        ...
        navigatorList.add(new BqRegionConverter(new ExpressionNavigator(), tnrc, tnc));
    ...
    protected ExpressionDeParser getExpressionDeparser(SelectDeParser dep, StringBuffer sb) {
        return new BqExpressionDeParser(dep, sb);
    }
    ...
    protected QuerySelectDeParser getSelectDeParser() {
        return new BqQuerySelectDeParser();
    }
}
