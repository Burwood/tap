...
public class SampleWebService implements AvailabilityPlugin {
    ...
    private static final String TAPDS_NAME = "jdbc/tapuser";
    // note tap_schema table names

    private final String TAPDS_TEST = "select schema_name from tap_schema.schemas11 where schema_name='tap_schema'";
